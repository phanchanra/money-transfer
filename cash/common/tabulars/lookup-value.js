...
tabularOpts.name = 'cash.lookupValue';
tabularOpts.collection = LookupValue;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.Cash_lookupValueAction},
    {data: "name", title: "Name"},
    {data: "private", title: "Private"},
    {
        data: "options",
        title: "Options",
        tmpl: Meteor.isClient && Template.Cash_lookupValueOptions
    },
];
