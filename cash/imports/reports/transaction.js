...
// Method
import {transactionReport} from '../../common/methods/reports/transaction.js';

// Schema
import {TransactionSchema} from '../../common/collections/reports/transaction.js';

// Page
import './transaction.html';

// Declare template
let indexTmpl = Template.Cash_transactionReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            transactionReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('Cash_transactionReport', hooksObject);
