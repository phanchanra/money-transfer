...
// Declare template
let indexTmpl = Template.Cash_lookupValue,
    optionsTmpl = Template.Cash_lookupValueOptions,
    formTmpl = Template.Cash_lookupValueForm;
...
formTmpl.onCreated(function () {
    this.autorun(()=> {
        ...
        if (currentData) {
            this.subscribe('cash.lookupValueById', currentData.lookupValueId);
        }
    });
});
...
AutoForm.addHooks(['Cash_lookupValueForm'], hooksObject);
