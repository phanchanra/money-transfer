...
// Declare template
var itemsTmpl = Template.MoneyTransfer_orderItems,
    actionItemsTmpl = Template.MoneyTransfer_orderItemsAction,
    editItemsTmpl = Template.MoneyTransfer_orderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'moneyTransfer.order.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('moneyTransfer.order.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection,
            {_id: this._id},
            {title: TAPi18n.__('moneyTransfer.order.schema.itemId.label'), itemTitle: this.itemId}
        );
    }
});
...
AutoForm.addHooks(['MoneyTransfer_orderItemsEdit'], hooksObject);
