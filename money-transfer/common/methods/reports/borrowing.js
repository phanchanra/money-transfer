...
export const borrowingReport = new ValidatedMethod({
    name: 'simplePos.borrowingReport',
    ...
    run(params) {
        if (!this.isSimulation) {
            ...
            selector.borrowingType = {$in: params.borrowingType};
            selector.borrowingDate = {$gte: fDate, $lte: tDate};
