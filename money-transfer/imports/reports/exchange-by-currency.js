...
// Method
import {exchangeByCurrencyReport} from '../../common/methods/reports/exchange-by-currency';

// Schema
import {ExchangeByCurrencySchema} from '../../common/collections/reports/exchange-by-currency';


// Page
import './../reports/exchange-by-currency.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_exchangeByCurrencyReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            exchangeByCurrencyReport.callPromise(formDataState.get())
                .then((result)=> {
...
indexTmpl.helpers({
    schema(){
        return ExchangeByCurrencySchema;
    },
    rptInit(){
...
AutoForm.addHooks('MoneyTransfer_exchangeByCurrencyReport', hooksObject);
