...
// Method
import {exchangeDetailReport} from '../../common/methods/reports/exchange-detail';

// Schema
import {ExchangeDetailSchema} from '../../common/collections/reports/exchange-detail';


// Page
import './../reports/exchange-detail.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_exchangeDetailReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            exchangeDetailReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('MoneyTransfer_exchangeDetailReport', hooksObject);
