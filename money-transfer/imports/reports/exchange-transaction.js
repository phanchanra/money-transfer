...
// Method
import {exchangeTransactionReport} from '../../common/methods/reports/exchange-transaction';

// Schema
import {ExchangeTransactionSchema} from '../../common/collections/reports/exchange-transaction';


// Page
import './../reports/exchange-transaction.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_exchangeTransactionReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            exchangeTransactionReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('MoneyTransfer_exchangeTransactionReport', hooksObject);
