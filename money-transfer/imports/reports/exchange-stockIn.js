...
// Method
import {exchangeStockInReport} from '../../common/methods/reports/exchange-stockIn';

// Schema
import {ExchangeStockInSchema} from '../../common/collections/reports/exchange-stockIn';


// Page
import './../reports/exchange-stockIn.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_exchangeStockInReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            exchangeStockInReport.callPromise(formDataState.get())
                .then((result)=> {
...
AutoForm.addHooks('MoneyTransfer_exchangeStockInReport', hooksObject);
