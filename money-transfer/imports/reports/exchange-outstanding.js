...
// Method
import {ExchangeOutstandingReport} from '../../common/methods/reports/exchange-outstanding';

// Schema
import {ExchangeOutstandingSchema} from '../../common/collections/reports/exchange-outstanding';

// Page
import './../reports/exchange-outstanding.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_exchangeOutstandingReport;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(() => {
        ...
        if (formDataState.get()) {
            ...
            ExchangeOutstandingReport.callPromise(formDataState.get())
                .then((result)=> {
...
indexTmpl.helpers({
    schema(){
        return ExchangeOutstandingSchema;
    },
    rptInit(){
...
AutoForm.addHooks('MoneyTransfer_exchangeOutstandingReport', hooksObject);
