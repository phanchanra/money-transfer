...
export const Order = new Mongo.Collection("moneyTransfer_order");
...
Meteor.startup(function () {
    Order.itemsSchema.i18n("moneyTransfer.order.schema");
    Order.schema.i18n("moneyTransfer.order.schema");
