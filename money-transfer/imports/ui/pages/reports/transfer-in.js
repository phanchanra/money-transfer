...
// Schema
import {TransferInSchema} from '../../../api/collections/reports/transfer-in';

// Page
import './../reports/transfer-in.html';

// Declare template
let indexTmpl = Template.MoneyTransfer_transferInReport;
...
AutoForm.addHooks('MoneyTransfer_transferInReport', hooksObject);
