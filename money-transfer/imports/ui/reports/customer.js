...
// Declare template
let formTmpl = Template.MoneyTransfer_customerReport,
    genTmpl = Template.MoneyTransfer_customerReportGen;
...
let hooksObject = {
    ...
    onSuccess: function (formType, result) {
        ...
        let path = FlowRouter.path("moneyTransfer.customerReportGen", params, queryParams);
...
AutoForm.addHooks('MoneyTransfer_customerReport', hooksObject);
